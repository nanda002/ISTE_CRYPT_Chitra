...
def run():
    ...
    img=tf.keras.preprocessing.image.load_img('C:/Users/Aneesh Kulkarni/Desktop/ChitraE/static/input/target.jpg')
    def decode(image):
        image=(image/127.5)-1
        return image
    ...
    tf.keras.utils.save_img('static/pics/target.jpg',img)
    tf.keras.utils.save_img('static/pics/result1.jpg',prediction)
    tf.keras.utils.save_img('static/pics/result2.jpg',prediction_150)
    tf.keras.utils.save_img('static/pics/result3.jpg',rev_pred_dis)
